...
import './InvestorDashboardBottom.css'
import daos from '../dao.json'
import getProviderOrSigner from '../../../../../contractInstance'
import DAO from '../../../../DAO/DAO'

const InvestorDashboardBottom = ({ registeredDAOs, setRegisteredDAOs }) => {
  ...
  return (
    <div className='investordashboardbottom-container'>
      <div> 
        <p className='headline'>DAOs invested in</p>
      </div>
...
export default InvestorDashboardBottom