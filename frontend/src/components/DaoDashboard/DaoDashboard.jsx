        ...
        <div className='description-part'>
          <div className='description-text'>
            <p className='dao-description'>
              Make the first step <br/> Register to the DAO <br/> Get a chance to acquire an investor 
            </p>
            <div>
              <button className="register-button" onClick={() => { handleShowModal("REGISTER", "This is the Register Modal Content"); connectWallet() }}>Register as a farmer</button>
              <button className="register-button" onClick={() => { handleShowModal("REGISTER", "This is the Register Modal Content"); connectWallet() }}>Register as an Investor</button>
